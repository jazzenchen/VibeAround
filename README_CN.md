...
最新桌面版：[VibeAround v0.7.20](https://github.com/jazzenchen/VibeAround/releases/tag/v0.7.20)。
...
| Windows x64 | [Setup EXE](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.20/VibeAround-Windows-x64-Setup-0.7.20.exe)、[MSI](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.20/VibeAround-Windows-x64-MSI-0.7.20.msi) 或 [免安装 ZIP](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.20/VibeAround-Windows-x64-Portable-0.7.20.zip) |
| Linux x64 | [AppImage](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.20/VibeAround-Linux-x64-AppImage-0.7.20.AppImage) 或 [deb](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.20/VibeAround-Linux-x64-DEB-0.7.20.deb) |
...
最新 CLI 包：[`@vibearound/cli@0.0.9`](https://www.npmjs.com/package/@vibearound/cli)。各平台 payload 单独记录在 [VibeAround CLI 0.0.9](https://github.com/jazzenchen/VibeAround/releases/tag/va-v0.0.9)。
