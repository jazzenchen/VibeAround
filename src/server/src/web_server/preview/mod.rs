...
//! `va_owner` cookie. Shared Server GET/HEAD requests revalidate that same
//! grant at the root proxy; the proxy does not forward `/va/*`, and the grant
//! does not include owner chat or review.
//!
//! ## Module layout
//!
