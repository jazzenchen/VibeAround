export const zhCNOnboarding: Record<string, string> = {
  ...
  "VibeAround will add an MCP server entry to your coding agents' global settings and install a handover skill for session transfer between devices. Your existing agent settings will not be overwritten.":
    "VibeAround 会向代码助手的全局设置添加 MCP 服务，并安装用于在不同设备间交接会话的技能。已有设置不会被覆盖。",
  ...
  "Setting up your agents and plugins...": "正在设置代码助手和插件...",
  ...
  Remote: "远程",
  Config: "设置",
  "Start with your coding agents.": "先选代码助手。",
  ...
  "Keep the defaults if you are not sure; everything can be changed later.":
    "不确定就保持默认，之后随时可以改。",
  Settings: "设置",
  "Agents to enable": "选择代码助手",
  "Select your favorite agents.": "选择你想使用的代码助手。",
  "More agents": "更多助手",
  "Hide more agents": "收起更多助手",
  Skip: "跳过",
  Ready: "可用",
  Installed: "已安装",
