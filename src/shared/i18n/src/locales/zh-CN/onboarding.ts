export const zhCNOnboarding: Record<string, string> = {
  ...
  "Action required": "需要手动操作",
  "Install failed": "安装失败",
  "Configure later": "稍后填写",
  "Setup available": "待安装",
  Complete: "已完成",
  "{{count}} failed": "{{count}} 项失败",
  "{{count}} action required": "{{count}} 项需要手动操作",
  "{{count}} ready": "{{count}} 项待安装",
  "{{count}} not attempted": "{{count}} 项尚未执行",
  "{{count}} to configure": "{{count}} 项待配置",
  "{{count}} installed": "{{count}} 项已安装",
  "{{count}} skipped": "{{count}} 项已跳过",
  "{{count}} item": "{{count}} 项",
  "{{count}} items": "{{count}} 项",
  "needs config": "待配置",
  ok: "已安装",
  ...
  "Retry failed": "重试失败项",
  "Skip remaining": "跳过剩余项",
  "Skip for now": "暂时跳过",
  "Skipped for now": "已暂时跳过",
  Undo: "撤销",
  "Launching...": "启动中...",
