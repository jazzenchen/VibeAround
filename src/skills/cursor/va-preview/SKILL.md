---
description: Start a local-only live preview for a running development server. Use after starting a dev server or when the user asks to preview a browsable artifact.
alwaysApply: false
---
...
Arguments:
  ...
  agent_kind: "cursor"  (pass with session_id when thread_id is unavailable)
