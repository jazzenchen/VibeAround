---
name: va-preview
description: "Exposes a local dev server or HTML file as a live preview via a shareable public URL, enabling browser and mobile device testing. Use when the user starts a dev server, creates HTML/CSS/JS files, or asks to 'preview this', 'show me on my phone', 'share a preview link', 'open in browser', or 'mobile preview'. Only available when the VibeAround MCP server is connected."
---
...
### 4. Present both links

The tool returns an Owner link and a Share link. Always show **both**:
