---
name: vibearound
description: "VibeAround Agent only: hand over the current coding session so the user can continue via any IM channel connected to VibeAround. Use when the user says \"/vibearound handover\", \"hand over this session\", \"continue on my phone\", or similar session transfer requests."
---
