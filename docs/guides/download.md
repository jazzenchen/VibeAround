...
The command-line distribution is published separately as [VibeAround CLI 0.0.6](https://github.com/jazzenchen/VibeAround/releases/tag/va-v0.0.6). Use the desktop links above for the packaged app, and the CLI release assets for terminal-first installs. If you prefer npm, install the current CLI with:
