...
5. **Review outputs** through [Live Preview](../guides/web-dashboard.md): paired owner links and code-gated Server/Markdown Shares work from the phone. Server Shares support GET/HEAD iframe navigations and browser-declared static subresources; browser fetch/XHR/EventSource, workers, non-GET/HEAD methods, WebSockets, and HMR are unsupported.
